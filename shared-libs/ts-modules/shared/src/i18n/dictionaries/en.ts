...
export const ENGLISH: Record<string, number> = {
  ...
  'Scheduled Backups': 894,
  'Scheduled checkpoints are stored separately from your latest manual checkpoint.': 895,
  'New service backup review': 896,
  'Choose whether to add this service to every selective job. The service cannot start until this is resolved.': 897,
  'Add to this job': 898,
  'Resolve review': 899,
  'Scheduled Jobs': 900,
  'Create Job': 901,
