...
export const ENGLISH: Record<string, number> = {
  ...
  'Scheduled Backups': 1131,
  'Scheduled checkpoints are stored separately from your latest manual checkpoint.': 1132,
  'New service backup review': 1142,
  'Choose whether to add this service to every selective schedule. The service cannot start until this is resolved.': 1143,
  'Add to this schedule': 1144,
  'Resolve review': 1133,
  'Automatic schedules': 1134,
  'Create new schedule': 1135,
  'Target': 1136,
  'Scope': 1137,
  'Next run': 1138,
  'Last result': 1139,
  ...
  'Retry target': 909,
  'Change target': 910,
  'No backup schedules': 911,
  'Edit backup schedule': 912,
  'Create backup schedule': 913,
  'Schedule name': 914,
  'Backup target': 915,
  'Select target': 916,
  'All installed services': 917,
  'Selected services': 918,
  'Schedule': 919,
  'Every hour': 920,
  'Every day': 921,
  'Every week': 922,
  ...
  'Retention': 926,
  'Latest only': 927,
  'Daily for one week': 928,
  'Interval hours': 931,
  'Coverage hours': 932,
  'Remove': 933,
  'Every retained version is a full copy. Each run also makes a full target-side staging copy. This can substantially increase storage use, runtime, and I/O, especially on network storage and slow external devices.': 935,
  'I understand the full-copy storage impact': 936,
  'Captured timezone': 937,
  'Maximum scheduled checkpoints per service': 938,
  'Change backup target': 939,
  'New target': 940,
  'Wait for next scheduled run': 941,
  'Existing snapshots are not migrated. They remain archived on the original target.': 942,
  'Scheduled Backup History': 943,
  'Checkpoints': 944,
  'Scheduled storage': 945,
  'Next-run staging': 946,
  'Last changed bytes': 947,
  'Archived': 948,
  'Restore': 949,
  'Delete archive': 950,
  'Scheduled': 951,
  'No scheduled checkpoints': 952,
  'Edit shared retention': 953,
  'This policy is shared by schedules': 954,
  'Preview changes': 955,
  'Estimated reclaimed space': 956,
  'Delete exactly the checkpoints listed above': 957,
  'Apply retention': 958,
  'Delete backup schedule?': 959,
  'Snapshots that are no longer referenced will be kept as an archive by default.': 960,
  'Delete archived checkpoints?': 961,
  'This permanently deletes every checkpoint in this archive.': 962,
  'Restore scheduled checkpoint?': 963,
  'The selected scheduled checkpoint will be restored.': 964,
  'Target unavailable': 965,
  'Target changed': 966,
  'Authentication required': 967,
  'Partially failed': 969,
  'Never run': 970,
  'All services': 971,
  'Sunday': 972,
  'Monday': 973,
  ...
  'Resume': 980,
  'Manual': 981,
  'Capacity estimates': 982,
  'Refresh estimates': 983,
  'Live data estimate': 984,
  'Manual checkpoint': 985,
  'Archived storage': 986,
  'Projected peak': 987,
  'No restorable checkpoints were found': 988,
  'Per-service retention overrides': 989,
  'Use default retention': 990,
  'Delete unreferenced checkpoints?': 991,
  'This schedule is the last reference to these checkpoints. Keeping the archive is the safe default.': 992,
  'Delete checkpoints': 993,
  'Keep archive': 994,
  'Choose action': 995,
  'Skip this schedule': 996,
  'About': 997,
  'Add or repair a location': 998,
  'Add or repair a physical drive or network folder': 999,
  'All activity': 1001,
  'All current and future services with exclusions': 1002,
  'Also permanently delete automatic backup checkpoints': 1003,
  'Automatic': 1004,
  'Automatic backups': 1005,
  'Automatic backups are already set up.': 1006,
  'Automatic backups are not set up yet.': 1007,
  'Automatic backups need attention': 1008,
  'Automatically include future services': 1009,
  'Back up every current and future service on a schedule.': 1010,
  'Backup location': 1011,
  'Backup locations': 1012,
  'Checkpoint for selected services': 1013,
  'Choose a backup location': 1014,
  'Choose a location with more free space.': 1015,
  'Choose a manual or automatic checkpoint': 1016,
  'Confirm the setup with your master password.': 1017,
  'Create a manual backup': 1018,
  'Create the first backup now': 1019,
  'Daily': 1020,
  'Day': 1021,
  'Existing service selection preserved': 1022,
  'Fix backup': 1023,
  'Frequency': 1024,
  'Help': 1025,
  'History': 1026,
  'Hourly': 1027,
  'Keep additional versions': 1028,
  'Keep one backup every': 1029,
  'Last successful backup': 1030,
  'Latest automatic': 1031,
  'Latest available': 1032,
  'Latest manual': 1033,
  'Manage backup locations': 1034,
  'Manage stored checkpoints': 1035,
  'Month': 1036,
  'Never': 1037,
  'Next backup': 1038,
  'No backup activity yet.': 1039,
  'No backup locations are available.': 1040,
  'Not scheduled': 1041,
  'Recommended so protection begins immediately.': 1042,
  'Restore from a backup': 1043,
  'Review automatic backups': 1044,
  'Run a one-time backup now': 1045,
  'Save changes': 1046,
  'Schedule and services': 1047,
  'Set up': 1048,
  'Set up automatic backups': 1049,
  'Settings': 1050,
  'Show': 1051,
  'Turn off and remove automatic backups': 1052,
  'Turn off automatic backups': 1053,
  'Turn on automatic backups': 1054,
  'Unavailable': 1055,
  'Version history': 1056,
  'View progress': 1057,
  'View retention details and archived checkpoints.': 1058,
  'Week': 1059,
  'Weekly': 1060,
  'You can leave this page. Progress will continue.': 1061,
  'available': 1062,
  'for': 1063,
  'needed': 1064,
  'periods': 1065,
  'Protect your services automatically, create a manual backup, or restore from an earlier checkpoint.': 1066,
  'Choose where and when StartOS protects your services.': 1067,
  'Change your primary schedule or review backup history': 1068,
  'Unavailable locations stay visible so you can repair them.': 1069,
  'All current and future services are included unless you exclude them.': 1070,
  'Keep only the latest automatic checkpoint': 1071,
  'Every retained version is a full copy and each run also needs temporary staging space.': 1072,
  'Your primary schedule is on.': 1073,
  'Automatic backups are off. Settings and checkpoints are kept.': 1074,
  'This schedule keeps its previous exact selection and will not silently add future services.': 1075,
  'Turning off pauses schedules. Deleting checkpoints is optional and never deletes manual backups.': 1077,
  'Add another exact time, customize a service, or repair a backup location.': 1078,
  'Use a physical drive or a shared folder on your local network.': 1079,
  'To add a physical location, connect a compatible drive to your Start9 Server, then refresh this page.': 1080,
  'For each selected service, this replaces its previous manual checkpoint. Automatic checkpoints are not changed.': 1081,
  'Latest automatic checkpoint only': 1082,
  'All current and future services': 1083,
  'Your services are protected on schedule.': 1084,
  'Automatic backups are off. Saved settings and checkpoints are kept.': 1085,
  'The backup location needs your password again.': 1086,
  'The connected backup location is not the expected location.': 1087,
  'StartOS cannot connect to the backup location.': 1088,
  'The latest automatic backup did not finish successfully.': 1089,
  'Restoring services': 1090,
  'Creating manual backup': 1091,
  'Creating automatic backup': 1092,
  'In progress': 1093,
  'Automatic backup': 1094,
  'All services with exclusions': 1095,
  'Available space unknown': 1096,
  'No backups found': 1097,
  'Retry backup location': 1098,
  'Change backup location': 1099,
  'New backup location': 1100,
  'Existing checkpoints are not moved. They remain archived at the original backup location.': 1101,
  'Backup location unavailable': 1102,
  'Backup location changed': 1103,
  'Automatic checkpoints are stored separately from your latest manual checkpoint.': 1104,
  'No automatic schedules': 1105,
  'Edit automatic schedule': 1106,
  'Create automatic schedule': 1107,
  'Automatic storage': 1108,
  'Maximum automatic checkpoints per service': 1109,
  'Wait for next automatic run': 1110,
  'Automatic backup history': 1111,
  'No automatic checkpoints': 1112,
  'Overview': 1113,
  'Manual backup': 1114,
  'Locations': 1115,
  'Backup history': 1116,
  'Turn off automatic backups?': 1117,
  'Turn off and delete': 1118,
