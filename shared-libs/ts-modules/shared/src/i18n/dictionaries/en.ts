...
export const ENGLISH: Record<string, number> = {
  ...
  'Coverage hours': 932,
  'Remove': 933,
  'Every retained version is a full copy. Each run also makes a full target-side staging copy. This can substantially increase storage use, runtime, and I/O, especially on CIFS and slow external devices.': 935,
