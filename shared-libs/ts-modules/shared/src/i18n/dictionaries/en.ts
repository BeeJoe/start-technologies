...
export const ENGLISH: Record<string, number> = {
  ...
  'Each version-history rule must be unique.': 1193,
  'Show password': 1194,
  'Hide password': 1195,
  'Unlock backup': 1196,
  'Enter the master password that was used to encrypt this backup.': 1197,
  'Delete network folder?': 1198,
  'Remove this network folder from StartOS?': 1199,
  'Stored backup files will remain on the network folder and can be reconnected later.': 1200,
  'Search date, status, or service': 1201,
  'All statuses': 1202,
  'This service did not complete successfully.': 1203,
  'Technical details': 1204,
  'Some services did not complete successfully. Review the affected services and try again.': 1205,
